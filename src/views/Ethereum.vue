<template>
  <static-page class="wide">
    ...
    <template #text>
      <p>
        You can register on this server with your <a href="https://ethereum.org/en/wallets/find-wallet/" target="_blank" rel="noopener">Ethereum wallet</a>.
        ...
        This can be achieved by using an exchange <a href="https://kycnot.me/" target="_blank" rel="noopener">that doesn't require identity verification</a>.
        For general privacy recommendations, visit <a href="https://www.privacyguides.org/en/" target="_blank" rel="noopener">PrivacyGuides</a> website.
      </p>
    </template>
  </static-page>
</template>
