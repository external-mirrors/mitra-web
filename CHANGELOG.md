...
- Updated translations ([#177](https://codeberg.org/silverpill/mitra-web/pulls/177)).
...
- Updated translations ([#174](https://codeberg.org/silverpill/mitra-web/pulls/174)).
...
- Don't show "Follow" button on user's own profile.
...
- Show "Group" badge when viewing group profile.
...
- Added "Groups" page and group timelines.
- Added ability to create posts in groups.
- Added "Load conversation" item to post menu (admin only).

### Changed

- Display plaintext unicode emoji symbols in reactions as explicit emojis.
- Updated translations ([#168](https://codeberg.org/silverpill/mitra-web/pulls/168)).

### Fixed

- Don't show page reload alert if attempt to load conversation fails.
- Fixed custom emoji size in emoji reaction notification.
- Fixed timeline marker appearing during loading.
...
- Don't show page reload alert if attempt to load latest/featured posts fails.
...
- Display all attached images in gallery.
...
- Fixed rendering of `<p>` blocks inside list items.
- Stop using deprecated identity proof endpoint.
...
- Show outgoing follow requests on "Follow requests" page.
...
- Don't show "Repost" in repost counter tooltip while author list is loading.
...
- Added "configure" button to custom feed header.
...
- Updated translations ([#148](https://codeberg.org/silverpill/mitra-web/pulls/148), [151](https://codeberg.org/silverpill/mitra-web/pulls/151)).
...
- Updated translations ([#147](https://codeberg.org/silverpill/mitra-web/pulls/147)).
...
- Removed support for token gate.

### Fixed

- Don't change toggled content warning button on hover.
...
- Don't show number of minutes in payment status when it is negative.
...
- Fixed custom emojis not being displayed in blockquotes.

## [4.12.0] - 2025-10-26

### Changed

- Display loader on identity proof page.
- Take minimum payment amount from a payment option attached to profile.
- Support displaying polls without end date.
...
- Updated translations ([#137](https://codeberg.org/silverpill/mitra-web/pulls/137)).

### Fixed

- Fixed "Pay" button not working when subscription is remote and Monero integration is not enabled.

## [4.10.1] - 2025-09-21

### Changed

- Updated translations ([#135](https://codeberg.org/silverpill/mitra-web/pulls/135)).
...
- Fixed image overflow in lightbox.

## [4.8.0] - 2025-08-18

### Added

- Allow local usernames containing uppercase letters and hyphens ([#129](https://codeberg.org/silverpill/mitra-web/pulls/129)).
- Display error message at subscription page if recipient doesn't exist.
- Display error message at gallery page if profile doesn't exist.

### Changed

- Replaced "Copy object ID" `<button>` with link.
- Added robots=noindex meta tag to `index.html`.
...
- Require `Status` entities to have `hidden` attribute.
- Set `order` parameter to `active` when accessing `/api/v1/directory`.
- Updated translations ([#130](https://codeberg.org/silverpill/mitra-web/pulls/130)).

## [4.6.0] - 2025-07-16

### Added

- Added Persian translation ([#127](https://codeberg.org/silverpill/mitra-web/pulls/127)).
- Support uploading from URL.
...
- Replace link target in mentions, hashtags and quote links.
- Updated translations ([#126](https://codeberg.org/silverpill/mitra-web/pulls/126)).

### Fixed

- Fixed broken custom emojis in bio when it is wrapped in `<div>` tag.
- Create greentext if there is a space after ">" sign.
...
- Set repost visibility to "Followers" if that is default post visibility.

### Changed

- Use parameter names without square brackets when creating and updating posts.
- Open lightbox when clicking on image in quote.
- Expand post menu upwards when dropdown doesn't fit into viewport.
...
- Fixed undoing reactions with custom emojis.
- Fixed non-square custom emojis covering surrounding text.

## [4.2.0] - 2025-05-06

### Added

- Added "Load featured posts" button to profile menu.
...
- Updated translations ([#100](https://codeberg.org/silverpill/mitra-web/pulls/100)).
...
- Display custom emojis and greentext when posts are viewed by a guest.
- Don't open new tab if viewing local profile/post as guest.
...
- Updated translations ([#72](https://codeberg.org/silverpill/mitra-web/pulls/72)).
...
- Updated translations ([#69](https://codeberg.org/silverpill/mitra-web/pulls/69)).

### Fixed

- Don't change color of disabled "Publish" button on hover.

## [3.19.0] - 2025-03-09

### Changed

- Added underline to instance name on welcome screen.
...
- Updated translations ([#67](https://codeberg.org/silverpill/mitra-web/pulls/67)).
...
- Navigate to parent post when clicking on "replying to".
...
- Allow emoji reactions with non-square images.
- Updated translations ([#65](https://codeberg.org/silverpill/mitra-web/pulls/65)).
...
- Switch to editing mode when clicking on preview.
- Expand ellipsized profile fields on click.
...
- Updated translations ([#64](https://codeberg.org/silverpill/mitra-web/pulls/64)).

### Fixed

- Removed Rollup warning about annotation during build.
...
- Auto-complete emoji shortcodes.
...
- Updated translations ([#62](https://codeberg.org/silverpill/mitra-web/pulls/62)).
...
- Updated translations ([#61](https://codeberg.org/silverpill/mitra-web/pulls/61)).

## [3.13.0] - 2024-12-28

### Added

- Display poll info and enable voting.
- Auto-focus on textarea in post editor.
